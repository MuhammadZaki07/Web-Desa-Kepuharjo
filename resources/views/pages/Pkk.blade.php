        ...
        <x-layouts-blogs>
            <x-flex-one>
                <x-content>
                    ...
                    <p class="text-sm text-gray-500 mb-6">Diperbarui pada: {{ $data['updated_at'] }}</p>
                    ...
                    @if (!empty($data['programs']))
                        <h2 class="text-xl font-semibold text-gray-800 mb-3">{{ count($data['programs']) }} Program Pokok
                            PKK</h2>
