<div class="group flex items-center bg-white shadow-sm border border-slate-400/[0.2] mt-10 overflow-hidden rounded-lg relative">
    ...
    <div class="overflow-hidden whitespace-nowrap w-full relative">
        <div class="animate-marquee inline-block">
            @foreach ($blogs as $blog)
                <a href="#" class="inline-flex items-center space-x-2 px-4 text-gray-800 hover:underline hover:animate-bounce-stop">
